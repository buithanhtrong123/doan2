        ...
        <?php
                ...
                $i=1;
                    ...
                    <tr>
                        ...
                        <td class='p-3'><a href="index_admin.php?nc=xacnhan&mahd=<?php echo $row['MaHD'];?>">Xong</a></td>
                        <td class='p-3'><a href="index_admin.php?nc=chitietdh&mahd=<?php echo $row['MaHD'];?>">Chi tiết</a></td>
                        <tr>
                    <?php
                    $i++;
                }
